...
import {MaskedGame} from '../src/game'
...
describe('A game', () => {
  ...
  it('should be rewindable to the previous turn', () => {
    ...
    //     ],
    //     revealedOtherPlayerCards: ['A4', 'A3', 'A2', 'A1', 'A1', 'B4', 'B2'],
    //   },
    //   players: [
    ...
    const maskedGame = new MaskedGame(turn8)
    expect(maskedGame.turns[2].getState(g.players[0].id)).toEqual(turn4.currentTurn)
  })
})
